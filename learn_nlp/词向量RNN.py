# Defined in Section 5.1.3.3--车万翔
# 基于N-gram的前馈神经网络语言模型 对下个词的预测仅有前N个词决定
# 基于循环神经网络语言模型处理不定长依赖
# 由当前词前面所有词预测该当前词后保存 model.embeddings.weight.data,实现词向量 
...
class RnnlmDataset(Dataset):
    def __init__(self, corpus, vocab):
        ...
        for sentence in tqdm(corpus, desc="Dataset Construction"):
            ...
            input = [self.bos] + sentence #  输入：<bos> w1 w2 ... wn
            # 模型输出：w_1, w_2, ..., w_n, EOS_TOKEN
            target = sentence + [self.eos] # 输出:   w1  w2 w3 ... <eos>
