# Defined in Section 5.3.1.2---车万翔书
# 基于N-gram的前馈神经网络语言模型  
# 由N个词预测下个词P(w(t)|w(t-n+2):(t-1))后保存 model.embeddings.weight.data,实现词向量 
    ...
    def __init__(self, corpus, vocab, context_size=2):
        ...
        for sentence in tqdm(corpus, desc="Dataset Construction"):
            ...
            for i in range(context_size, len(sentence)):
                ...
                context = sentence[i-context_size:i]  # w(t-n+2):(t-1)
                # 模型输出：当前词
                target = sentence[i]              # w(t)
