...
def get_ner_tags(logits, token_ids, entities, SEP_IDX=102):
    """
    :param logits:  [src_len,batch_size,num_classes]
    ...
    logits = logits.transpose(0, 1)  # [src_len,batch_size,num_classes]
    ...
    logits = logits[1:].transpose(0, 1)  # [batch_size,src_len-1,num_classes]
