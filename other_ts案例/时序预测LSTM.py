...
y_train = features.iloc[start:end][[1]]  # Temperature
...
inputs = keras.layers.Input(shape=(inputs.shape[1], inputs.shape[2])) # (None, 120, 7)
lstm_out = keras.layers.LSTM(32)(inputs)  # (None, 32)
outputs = keras.layers.Dense(1)(lstm_out) # (None, 1)
