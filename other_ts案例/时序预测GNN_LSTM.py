...
# we will only work with a sample of 26 roads out of the 228 roads in the dataset
sample_routes = [
    0,
    1,
    4,
...
print(f"speeds_array shape={speeds_array.shape}") # (12972, 26)
...
forecast_horizon = 3
multi_horizon = False
# Assume forecast_horizon=3. If multi_horizon=True then the model will make a forecast for time steps t+T+1, t+T+2, t+T+3. 
# if multi_horizon=False, the model will make a forecast only for time step t+T+3 
...
def compute_adjacency_matrix(
    ...
    Returns:
        A boolean graph adjacency matrix. where 1 means there is an edge between two nodes. 
    """
